  ...
  if (!data) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-4">
        ...
        <p className="text-sm text-slate-600">Extract all tables from this document</p>
  ...
  if (data.table_count === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-3">
        ...
        <p className="text-sm text-slate-500">No tables found in this document.</p>
  ...
  return (
    <div className="flex flex-col gap-3 p-5 overflow-y-auto">
      <div className="flex items-center justify-between">
        <p className="text-sm font-semibold text-slate-700">{data.table_count} table(s) found</p>
          ...
          >
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-slate-700">
                {t.caption || `Table ${i + 1}`}
                <span className="ml-2 text-xs font-normal text-slate-400">page {t.page}</span>
              </CardTitle>
